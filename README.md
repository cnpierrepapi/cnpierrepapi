...
<p align="center">
  <img src="https://img.shields.io/badge/Python-49%25-3776AB?style=for-the-badge&logo=python&logoColor=white" alt="Python 49 percent"/>
  <img src="https://img.shields.io/badge/TypeScript-39%25-007ACC?style=for-the-badge&logo=typescript&logoColor=white" alt="TypeScript 39 percent"/>
  <img src="https://img.shields.io/badge/HTML-7%25-E34F26?style=for-the-badge&logo=html5&logoColor=white" alt="HTML 7 percent"/>
  <img src="https://img.shields.io/badge/CSS-3%25-1572B6?style=for-the-badge&logo=css3&logoColor=white" alt="CSS 3 percent"/>
</p>
...
**🧬 [Ariadne](https://github.com/cnpierrepapi/ariadne)** | *Python, Next.js, TypeScript, DataHub lineage* | Aug 2026 | **[Live](https://ariadne-five.vercel.app)**
...
- [datahub#19405](https://github.com/datahub-project/datahub/pull/19405) · **merged 24 Aug 2026** · The permission check for a column incident asked whether you could edit the column, and nobody holds permissions on a column. It now asks about the parent dataset, which is where permissions actually live. Without it the new tab renders for everyone and the button is greyed out for everyone, which is worse than no tab.
...
Building MIGRAGENT on [Google's Agent Development Kit](https://github.com/google/adk-python) turned up four things worth sending back. The first one is mine and is now a pull request, opened after a maintainer asked for it. The other three are threads somebody else opened where I could add the measurement or the workaround that was missing. All four came out of shipping on it, not from reading the tracker.

- [adk-python#6880](https://github.com/google/adk-python/issues/6880) · open · A custom model class gets handed one config object holding 35 fields that belong in three different places in the request, and nothing says which is which. Put the tools in the wrong half and the call still returns 200, so your agent silently has no tools and answers from memory. Filed with a repro that runs offline. A maintainer checked the field table against the client library and confirmed it.
- [adk-python#6935](https://github.com/google/adk-python/pull/6935) · open · The fix for the one above. Rather than document where each of the 35 fields goes, it hands the job to the converter the official client already uses, so there is one copy of the mapping and it moves when the library moves. I had argued that a written list would go stale. Mine already had: the version I posted the day before was wrong by two fields.
